...
public class SignUpPage {
	...
	public SignUpPage(EnvSetUp envSetup) {
	...
	public void clickCreateAccount() {
		WebElement webelementCreateNewAccountBtn = objEnvSetup.getDriver()
				.findElement(By.xpath("//a[text()='Create New Account']"));
		webelementCreateNewAccountBtn.click();
